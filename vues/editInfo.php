        ...
        <div class="left-container">
            ...
            <div class="desc">
                <p><svg width="99px" height="99px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    Sélectionner un pays à modifier :</p>
            </div>
            <div class="form-container">
                <form name="paysForm" action="editInfo2.php" method="POST">
                    ...
                    <input type="submit" class="editButton" value="Modifier le pays">
                </form>
            </div>
        </div>
        <div class="mid-container">
            ...
            <div class="desc">
                <p><svg width="99px" height="99px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    Sélectionner un lieu à modifier :</p>
            </div>
            <div class="form-container">
                <form name="lieuForm" action="editInfo2.php" method="POST">
                    ...
                    <input type="submit" class="editButton" value="Modifier le lieu">
                </form>
            </div>
        </div>
        <div class="right-container">
            ...
            <div class="desc">
                <p><svg width="99px" height="99px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    Sélectionner un plat à modifier :</p>
            </div>
            <div class="form-container">
                <form name="gastroForm" action="editInfo2.php" method="POST">
                    ...
                    <input type="submit" class="editButton" value="Modifier le plat">
                </form>
            </div>
        </div>
</body>
